...
public class MainDashBoard_Promotion_PieGraph extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		for (SumPromotionShop sp : spr) promotionname.add("("+(currencyformatter.format((sp.getDiscount()*100)/totaldis))+"%) "+sp.getPromotionName()+" ("+(currencyformatter.format(sp.getDiscount()))+" "+currencysymbol+")");
